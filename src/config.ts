...
export function getConfigDir(): string {
  return (
    process.env.XIANCHOU_CONFIG_DIR ||
...
export async function readStoredConfig(): Promise<XianchouConfig> {
  try {
...
export async function writeStoredConfig(config: XianchouConfig): Promise<void> {
...
export async function resolveConfig(): Promise<Required<XianchouConfig>> {
